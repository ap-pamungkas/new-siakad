        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    $userImage = $user->foto ? url('system/public/images' . $user->foto) : url('public/images/profile.png');
                    @endphp
    ...
    <div class="logo-box">
        <a href="#" class="logo text-center logo-dark">
            <span class="logo-lg">
                ...
                <img class="bg-light" src="{{url('public/images/logo.png')}}" alt="" height="100">
                
            </span>
            <span class="logo-sm">
                <!-- <span class="logo-lg-text-dark">S</span> -->
                <img class="bg-light" src="{{url('public/images/logo.png')}}" alt="" height="50">
            </span>
        </a>
