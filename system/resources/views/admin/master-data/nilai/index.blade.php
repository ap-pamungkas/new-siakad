...
<x-tables.table id="datatable" >
    ...
    <tbody>
     ...
     <tr>
      ...
      <x-tables.td-action >
        {{-- <x-button.btn class="info" title="Info" icons icon="info" url="kelas-siswa/show/{{$kelas_siswa['kelas_siswa_id']}}/" />
        {{-- <x-button.delete id="{{$kelas_siswa['kelas_siswa_id']}}" />  --}}
  ...
  <div class="row mt-4">
    <div class="col-md-3">
        <label for="" class="form-label">Nilai Tugas</label></label>
        <input type="text" name="nilai_tugas"  class="form-control">

     
    </div>
    <div class="col-md-3">
        <label for="" class="form-label">Nilai Ulangan</label></label>
